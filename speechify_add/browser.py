...
async def _find_first_visible(page, selectors, step, timeout=5_000):
    # Build a combined locator using .or_() so Playwright waits for *any* of
    # the selectors to become visible within the full timeout budget, rather
    # than dividing the budget across each selector individually.
